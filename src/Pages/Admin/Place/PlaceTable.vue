    ...
    <table class="w-full text-sm text-left rtl:text-right text-body">
      ...
      <tbody>
        ...
        >
          ...
          <th scope="row" class="px-6 py-4 font-medium text-heading whitespace-nowrap">iPad</th>
